      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 relative mb-8 md:mb-0">
            ...
            <img src="https://images.unsplash.com/photo-1519781542286-35e5a187145d?q=80&w=1974&auto=format&fit=crop" alt="Worker 2" className="absolute top-1/2 left-1/2 transform -translate-x-1/4 -translate-y-1/4 rounded-full border-4 sm:border-8 border-white shadow-2xl w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 object-cover" />
          </div>
          <div className="md:w-1/2 md:pl-8 lg:pl-12">
            <h2 className="text-sm font-bold text-blue-500 uppercase mb-2">Who We Are</h2>
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4">Your Trusted Partner in Construction and Services</h3>
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
              ...
              <div className="flex items-center">
                <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Founder" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full mr-3 sm:mr-4" />
                <div>
